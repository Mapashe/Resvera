            ...
            React.createElement("div", { className: className },
                React.createElement("div", { className: "carousel_inner" }, [
                    ...
                    React.createElement("div", { className: "carousel_info" },
                        ...
                        this.props.id === "Facial Hydratance" ? (
                            React.createElement("div", { style: { display: "flex" } },
                                React.createElement("img", { style: { height: "40%" }, src: ".././img/empty.png" }, null),
...
var textos = ["Facial Lifting", "Facial Hydratance", "Nefertiti Experience", "Facial Magnetic Detox", "Deep Cleanse", "Facial Aqua Lift", "Facial Petal Peel"];
var imagenes = [".././img/fac3.png", ".././img/fac1.png", ".././img/fac7.png", ".././img/fac6.png", ".././img/fac5.png", ".././img/fac4.png", ".././img/fac2.png"]
var stars = [".././img/empty.png", ".././img/empty.png", ".././img/empty.png", ".././img/empty.png", ".././img/empty.png", ".././img/empty.png", ".././img/empty.png", ]
var tiempos = ["", "", "", "", "", "", ""]
var enlace = ["../Faciales/FLifting.html", "../Faciales/FHidratante.html", "../Faciales/FNefertiti.html", "../Faciales/FDetox.html", "../Faciales/FDeep.html", "../Faciales/FAqua.html", "../Faciales/FPetal.html"]
