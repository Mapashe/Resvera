            ...
            React.createElement("div", { className: className },
                React.createElement("div", { className: "carousel_inner" }, [
                    ...
                    React.createElement("div", { className: "carousel_info" },
                        ...
                        this.props.id === "Reskin" ? (
                            React.createElement("div", { style: { display: "flex" } },
                                React.createElement("img", { style: { height: "40%" }, src: "../img/empty.png" }, null),
                                React.createElement("p", {}, "")
                            )
                        ) :
                        this.props.id === "Skin Glow" ? (
                            React.createElement("div", { style: { display: "flex" } },
                                React.createElement("img", { style: { height: "40%" }, src: "../img/empty.png" }, null),
                                React.createElement("p", {}, "")
                            )
                        ) :
                        this.props.id === "Diamond Lifting" ? (
                            React.createElement("div", { style: { display: "flex" } },
                                React.createElement("img", { style: { height: "40%" }, src: "../img/empty.png" }, null),
                                React.createElement("p", {}, "")
                            )
                        ) :
                        this.props.id === "Skin Renew" ? (
                            React.createElement("div", { style: { display: "flex" } },
                                React.createElement("img", { style: { height: "40%" }, src: "../img/empty.png" }, null),
                                React.createElement("p", {}, "")
                            )
...
var textos = ["Skin Glow", "Reskin", "A New Beginning", "Luxe Resurfacing", "Skin Renew", "Diamond Lifting"];
var imagenes = ["../img/tec2.png", "../img/tec1.png", "../img/tec6.png", "../img/tec5.png", "../img/tec4.png", "../img/tec3.png"]
var stars = ["../img/empty.png", "../img/empty.png", "../img/empty.png", "../img/empty.png", "../img/empty.png", "../img/empty.png"]
var tiempos = ["", "", "", "", "", ""]
var enlace = ["../Tecnologia/TSkinGlow.html", "../Tecnologia/TReskin.html", "../Tecnologia/TNewBeg.html", "../Tecnologia/TLuxe.html", "../Tecnologia/TSkinRenew.html", "../Tecnologia/TDiamond.html"]
